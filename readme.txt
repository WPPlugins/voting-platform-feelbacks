...
Users react to your content by clicking on one of the 5 emotions.

= NOW WITH THE MOST ADVANCED EMOTION ANALYTICS FOR YOUR SITE!!! =
...
Comment systems are a great way for your visitors to react to the content but require a larger commitment on the part of your users. With only comments on a site, you may miss out on hearing from your quieter visitors. Feelback Reactions provide a quick and easy way for users to react to the content with just the click of a button.

= Get Immediate Feedback =
Users reactions are displayed immediately. Learn what emotions users are feeling and which content is evoking the most emotion.

= Emotion Analytics Dashboard =
The 1st and only analytics platform that actually shows you how your audience feels about your content.
...
= Customize Your Text =
You can now completely customize your text using your new Emotion Dashboard. Follow the directions [here](https://vicomi.zendesk.com/hc/en-us/articles/205862831-How-do-I-change-my-Feelbacks-text-)
...
NEW GAME OF THRONES THEME NOW AVAILABLE!

= Facebook Share Options =
After your users click on a reaction, prompt them to share the page on their Facebook wall.

= Feelback Reactions and Emotion Analytics are FREE! =
...
2. Emotional stylish voting platform - choose your own look and feel.
3. Choose between emoji icons and text buttons
4. Get emotional Feedback from your users
5. Increase user engagement on your site.
6. Choose your own look and feel.
7. Recommendation content widget helps increase page-views and engagement.
8. Free analytics and admin tools in our Emotion Dashboard.

== Installation ==

Installation

1. Download Vicomi Feelbacks plugin file.
...
= 1.27 =
* New Emotion Analytics

= 1.28 =
* New Screenshots/Icons
* Info about text customization
...
= 1.30 =
* Bug fix for Wordpress 4.5.2

= 1.34 =
* Option to adjust content recommendation settings

= 1.35 =
* Bug fix

= 1.36 =
* Dashboard and analytics improvments

= 1.37 =
* New Icons and design options and bug fixes

= 1.38 =
* New Feelbacks Icons and design options and bug fixes
